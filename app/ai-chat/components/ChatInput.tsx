      ...
      <form onSubmit={handleSubmit} className="flex items-end space-x-3">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className={`w-full px-4 py-3 border rounded-2xl resize-none focus:outline-none text-sm transition-all duration-200 ${
              isFocused 
            ...
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
              <div 
                className={`w-2 h-2 rounded-full ${
                  showValidationError ? 'bg-red-500' : 'bg-gray-400'
                }`}
        ...
        <button
          ...
          className={`px-4 py-3 rounded-2xl font-medium text-sm transition-all duration-200 flex items-center justify-center min-w-[52px] ${
            isSubmitDisabled
